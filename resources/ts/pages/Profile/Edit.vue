    ...
    <AppTempLayout>
        <div class="flex flex-col gap-1">
            ...
            <div class="flex flex-col">
                ...
                <span class="text-sm text-red-500 cursor-pointer underline" @click="form.country = ''">Reset country</span>
            ...
            <div class="flex flex-col gap-1">
                ...
                <span class="text-sm text-red-500 cursor-pointer underline" @click="form.gender = 'hidden'">Reset gender</span>
            </div>

            <div class="flex flex-col gap-1">
                <span>Date of Birth:</span>
                <input v-model="form.dob" type="date" class="border"/>
                <span class="text-sm text-red-500 cursor-pointer underline" @click="form.dob = null">Reset date of birth</span>
            </div>
